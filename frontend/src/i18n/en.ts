...
export const en = {
  ...
  "browser.colInSnapshot": "Snapshot Size",
  "browser.colOnDisk": "Disk Size",
  ...
  "app.openAll": "Open all ({count})",
  "app.macosRefused": "macOS would not mount the snapshot.",
  "app.free": "free",
  "health.nothingToActOn": "Nothing to act on. Snapshots exist, something is taking more, and the retention you set is the retention you will get.",
  "health.newest": "Newest {when}.",
  "health.nextDue": "Next due {when}.",
  "health.takeEvery": "Take one every {hours} hours",
  "health.willTakeEvery": "Snapshots will now be taken every {hours} hours",
  "health.days": "{n} days",
  "health.hours": "{n} hours",
  "health.underAnHour": "under an hour",
  "health.unknownLocation": "an unknown location",
  "search.restoredTo": "Restored to {path}",
  "schedule.log": "Log",
  "schedule.writtenBy": "Written by the scheduled task at",
  "schedule.reachingBack": "reaching back",
  "schedule.whyNeeded": "macOS only takes local snapshots on its own when Time Machine has a backup disk configured. This schedule takes them without one. It needs no password: creating and deleting snapshots goes through Time Machine's own background service.",
