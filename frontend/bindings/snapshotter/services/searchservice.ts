 ...
 */
export function DeletedSince(snapshotName: string, livePath: string, deep: boolean): $CancellablePromise<diffs$0.Result> {
    return $Call.ByID(2851642391, snapshotName, livePath, deep).then(($result: any) => {
