 ...
 */
export function FileVersions(device: string, snapshotName: string, livePath: string, targetSnapshot: string): $CancellablePromise<$models.FileVersions> {
    return $Call.ByID(3591362334, device, snapshotName, livePath, targetSnapshot).then(($result: any) => {
